<script lang="ts">
	...
	import { connectionLabel, torStatus, refreshTorStatus } from '$lib/stores/connection';
	...
	<div class="app-layout">
		<nav class="sidebar">
			...
			<div class="sidebar-footer">
				<div class="connection-status" class:connected={$torStatus.status === 'Connected'} class:disabled={$torStatus.status === 'Disabled'}>
...
<style>
	...
	.status-dot {
		...
		height: 8px;
		border-radius: 50%;
		background: var(--color-tor-error);
	}

	.connection-status.connected .status-dot {
		background: var(--color-tor-connected);
	}

	.connection-status.disabled .status-dot {
